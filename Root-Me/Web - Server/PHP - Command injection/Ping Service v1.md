...
Đầu tiên, giao diện Website chỉ có 1 chức năng Ping duy nhất:

![alt text](image.png)

Ta thử điền google.com vào thì Website trả về kết quả như sau:
...
Để tìm ra câu trả lời thì ta sẽ thử payload input như sau: `google.com; ls -la`
